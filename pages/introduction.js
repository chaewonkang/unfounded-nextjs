                ...
                <div css={invitationBox} ref={scrollRef}>
                        ...
                        <div css={invitationText2}>
                            <div>
                                <p css={theme.textKr}>
                                    ...
                                    형식에는 따로 제한을 두지 않으며 일반적인
                                    전시 기획서부터 이미지 아카이브까지, 각자의
                                    주제에 맞는 형식을 채택하기로 한다. 이때,
                                    픽션-전시란 픽션으로만 존재할 수 있는 전시,
                                    그 자체로 픽션을 생산하는 전시, 픽션을
                                    주제로 차용하는 전시 등 다양할 수 있다. 이를
                                    통해 전시의 스코어인 전시 기획서와 픽션의
                                    관계를 재고한다.
                                </p>
                                <p css={theme.textEn}>
                                    Six art exhibition planners gather to write
                                    a fiction-exhibition plan. There are no
                                    restrictions on the format of the exhibition
                                    plan to be produced, and it is decided to
                                    adopt a format suitable for each subject,
                                    from general exhibition plans to image
                                    archives. At this time, fiction-exhibition
                                    can be diverse, such as an exhibition that
                                    can exist only as fiction, an exhibition
                    ...
                    <div css={sliderContainer}>
                        <div css={sliderArrow}>
                            ...
                            <div
                                onClick={() => {
                                    if (index < invitation1.length / 3 - 1) {
                                        setIndex(index + 1);
                                    } else if (
                                        index ==
                                        invitation1.length / 3 - 1
                    ...
                    <div css={theme.marquee}>
                        <div css={marqueeBox1}>
                            <span style={{ color: "#fff" }}>
                                INVITATION II: Text Babel INVITATION II: Text
                                Babel INVITATION II: Text Babel&nbsp;
                            </span>
                        </div>
                        <div css={marqueeBox2}>
                            <span style={{ color: "#fff" }}>
