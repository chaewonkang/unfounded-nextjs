const InvitationOneData = [
    ...
    },
    {
        ...
        projectInfo:
            "미싱노미술관에 오신 것을 환영합니다. <br />미싱노 미술관은 불완전하게 삭제된 것을 대표하는 문화공간으로 자리 잡고자 개관하였습니다. 1996년 이래로 미싱노를 방문한 이들의 의견을 두루 모아서, 2021년 공포의 근원지나 분실물 보관소가 아닌 미술관으로 새로운 도약하고자 합니다. 미싱노 미술관은 제한, 오류, 상실을 넘어서서 모든 색과 형태를 환영합니다. 예술과 시대의 변화에 민감하게 반응하고 관객과 함께하며 성장하는 미술관이 되고자 합니다. 실험적이고 창의적이고 개방적인 미술관에 오신 여러분을 환영합니다. <br /><br />미싱노미술관 관장 000",
    },
    {
        index: 2,
    ...
    },
    {
        ...
        link: "",
        no: "06",
        artistInfoKr: `시각예술 분야에서 활동하는 기획자다. 미술을 소개하는 자리에서 기획자가 설정할 수 있는 조건들을 감지하고 이를 작품과 연결하며 새로운 사건이 생성될 수 있는 상황을 만든다. 전시장의 시공간과 그곳을 오가고 머무는 이들, 그리고 그들의 신체에 대한 관심을 갖고 있다. 《piercer》(서울시립미술관SeMA창고, 2021), 《perform2019: Linkin-out》(국립아시아문화전당, 일민미술관, 2019)을 기획하고 《best regards, Weave Wave》(중간지점, 2021)을 공동 기획했다. 현재 퍼포먼스 소장 연구 프로젝트 《Perform Collection System》(2021)의 온라인 오픈을 준비 중으로, 12월 중 홈페이지(<a href="https://www.performplace.org" target="_blank">performplace.org</a>)를 통해 공개할 예정이다.`,
        artistInfoEn: `Somi Lee believes in the power of the world that is completed when setting the conditions of exhibition, including time and space, the scenes and senses perceived there. Research and imagine the conditions surrounding the performance, explaining women in visual language, and art accessible to various bodies. Curating 《Perform Collection System》, (<a href="https://www.performplace.org" target="_blank">performplace.org</a>, 2021), 《perform2019: Linkin-out》(Asia Culture Center, Ilmin Art Museum, 2019),  《piercer》(SeMA Warehouse, 2021) that weaving each collection’s time and space, 《best regards, Weave Wave》(co curating, jungganjijeom, 2021) that making public・private relationship with female artist,  Braille drawing book, 『Black Spell Hotel』(2022).`,
        projectInfo:
            "이솜이는 기획, 전시, 도큐멘테이션을 포함하는 과정, 전시의 탄생부터 죽음까지를 ‘전시생애사’로 설정한다. 여기서 전시는 기획 단계에서의 기획, 즉 픽션이 ‘실현・구체화・물질화(materialize)’되는 아주 일시적인 순간으로, 이를 목격한 이들은 그 존재를 확인하고 지켜볼 수 있는 순간을 갖게 된다. 기획 단계에서 큐레이터의 진지한 픽션이 그의 머릿속에서만 시뮬레이션 및 수정의 과정을 거치며 머물다가 물리적인 공간, 꽤 냉철한 실시간성, 다른 이들과의 관계 등 전시의 조건들에 접촉한다. 전시의 탄생 단계에서는 픽션이 강력히 작용한다면, 그가 전시로 물질화, 혹은 실현되는 단계부터는 전시의 구조가 다시 한번 흔들리며 위기를 겪거나 전시 환경을 딛고 확장하며 새로운 돌파구를 찾는다. 2021년 12월, 이미 지나간 전시, 《HOLE》을 지나간 사건으로 다루지 않고 전시 이전과 이후를 오가며 그 선후 관계를 교란시키는 복잡한 생애사를 소개하려 한다. 《HOLE》은 물리적인 조건, 협력자들 간의 관계 등과의 만남을 지나며 기획자가 예측했던 바와는 다르게 흘러가는데..",
    },
];

export default InvitationOneData;
